...
class ImportAssetMetadata extends ImportClass {
  ...
  async updateExistingAssets() {
    ...
    let res = await this.connection.update(this.helper.namespace('Digital_Asset__c'), this.tempAssetsToUpdate);
    this.log.addToLogs(res, this.helper.namespace('Digital_Asset__c'));
  }
