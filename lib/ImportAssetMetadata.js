...
class ImportAssetMetadata extends ImportClass {
  ...
  async populateDigitalAssetAttributeValues() {
    ...
    await pimAttributeValue.populateWithDigitalAssetValues(Array.from(this.existingAssetMap.values()), this.labelNames);
    this.attributeValues = pimAttributeValue.getAttributes();
