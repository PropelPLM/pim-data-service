...
class ImportAssetMetadata extends ImportClass {
  ...
  createNewAssets() {
    ...
    for (let x = 0; x < this.propelParser.nodes.length; x++) {
      ...
      // tempAsset['Content_Location__c'] = getCDN // identifier used to identify CDN
  ...
  isCDNSupported(url) {
    // url should be https://{baseUrl}/{pathId} e.g. https://d3uk1mqqf9h27x.cloudfront.net/00DHu000001IObVMAW/9adcaab5-966b-4fbf-ba9b-ed716d2ce0cc
