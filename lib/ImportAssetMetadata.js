    ...
    for (let x = 0; x < this.propelParser.nodes.length; x++) {
      ...
      if (
        ...
        this.labelNames.forEach((label) => {
          this.createTempAttributeValueObjects(label.slice(1, -1), assetSObjectId, this.propelParser.nodes[x][label]);
        ...
        console.log('this.tempAttrValuesToUpdate: ', this.tempAttrValuesToUpdate)
