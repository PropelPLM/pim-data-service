...
class ImportAssetMetadata extends ImportClass {
  ...
  async createNewAssets() {
    ...
    for (let x = 0; x < this.propelParser.nodes.length; x++) {
      ...
      tempAsset['Category__c'] = this.categoryMap.get(this.propelParser.nodes[x]['Category ID']);
      tempAsset['External_File_Id__c'] = 'N.A.';
      tempAsset['Content_Location__c'] = 'N.A.';
      ...
      tempAsset['View_Link__c'] = this.propelParser.nodes[x].CDN_URL;
