...
class ImportAttributeTab {
  ...
  async processLineByLine() {
    ...
    this.propelParser.nodes.forEach((node) => {
      ...
      tmpAttributeGroup[this.helper('Attribute_Tab__c')] = this.attributeTabNameMap.get(node.attribute_tab)

      attributeGroups.push(tmpAttributeTab)
    })
    ...
    this.populateAttributeGroupMap()
  }
